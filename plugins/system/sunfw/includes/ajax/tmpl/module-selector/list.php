...
<form method="post" name="adminForm" id="adminForm" class="container-fluid form-select-module" action="<?php echo $this->baseUrl; ?>">
	<div class="row">
		<div class="col-xs-3 searchtools-module-container-filters">
			...
			<div class="searchtools-module-field-filter">
				<?php $this->renderStateOptions($this->session->get('filters.sunfw.widget.modules.list.state', ''), 'state');?>
			</div>
			<div class="searchtools-module-field-filter">
				<?php $this->renderModulePositionOptions($this->session->get('filters.sunfw.widget.modules.list.position', ''), 'position');?>
			</div>
			<div class="searchtools-module-field-filter">
				<?php $this->renderModuleTypeOptions($this->session->get('filters.sunfw.widget.modules.list.module', ''), 'module');?>
			</div>
			<div class="searchtools-module-field-filter">
				<?php $this->renderAccessOptions($this->session->get('filters.sunfw.widget.modules.list.access', ''), 'access');?>
			</div>
			<div class="searchtools-module-field-filter">
				<?php $this->renderLanguageOptions($this->session->get('filters.sunfw.widget.modules.list.language', ''), 'language');?>
			</div>
			<div class="clearfix">
