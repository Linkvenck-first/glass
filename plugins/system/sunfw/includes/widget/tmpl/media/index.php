...
<link href="<?php echo JUri::root(); ?>plugins/system/sunfw/assets/joomlashine/admin/css/general.css?v=<?php echo SUNFW_VERSION; ?>&d=<?php echo SUNFW_RELEASED_DATE; ?>" rel="stylesheet" />
