...
class hikashopLimitType{
	...
	function display($map, $value, $listing = false){
		$this->load($listing);
		return JHTML::_('select.genericlist',   $this->values, $map, 'class="custom-select" size="1" onchange="this.form.submit();"', 'value', 'text', $value );
	}
}
