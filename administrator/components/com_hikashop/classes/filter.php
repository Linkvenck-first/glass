...
class hikashopFilterTypeClass extends hikashopClass {
	...
	function getDeleteButton($filter, $divName, $val, $html, $br, $onlyButton=false, $id=''){
		...
		if($onlyButton){
			...
			return '<a href="#" style="cursor:pointer; text-decoration:none" onclick="'.$empty.$submitOnClick.'return false;" title="'.JText::_('REMOVE_THIS_SELECTION').'"><i class="fa fa-times-circle"></i></a>';
		}
		...
		$html.='  <a href="#" style="cursor:pointer; text-decoration:none" onclick="'.$empty.$submitOnClick.'return false;" title="'.JText::_('REMOVE_THIS_SELECTION').'"><i class="fa fa-times-circle"></i></a><br/>';
		return $html;
	}
