...
class plgHikashopUserpoints extends hikashopPlugin {
	...
	public function onHikashopBeforeDisplayView(&$view) {
		...
		if($points > 0) {
			$view->extraData->topMain[] =  '<div class="hk-well hikashop_user_points_cpanel"><i class="fa fa-2x fa-coins" style="margin-right: 10px;"></i> '. JText::sprintf('USERPOINTS_HAVE_X_POINTS', $points) . '</div>';
		} else {
			$view->extraData->topMain[] = '<div class="hk-well hikashop_user_points_cpanel"><i class="fa fa-2x fa-coins" style="margin-right: 10px;"></i> '.  JText::_('USERPOINTS_NO_POINTS') . '</div>';
		}
