...
echo JHTML::_('calendar', $start, 'data[widget][widget_params][start]','period_start','%Y-%m-%d %H:%M',array('size'=>'20'));
echo ' '.JText::_('END_DATE').' ';
echo JHTML::_('calendar', $end, 'data[widget][widget_params][end]','period_end','%Y-%m-%d %H:%M',array('size'=>'20'));
?>
									<br/>
